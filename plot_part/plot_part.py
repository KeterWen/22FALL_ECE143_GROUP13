...
df_maths = pd.read_csv('Maths.csv')
df_port = pd.read_csv('Portuguese.csv')
...
def plot_bar_studytime_vs_G(df_maths, df_port, save_path='./plot/bar_studytime_vs_G.png'):
    ...
    for i in range(len(keys_list)):
      ...
      if 'G3' in key_i:
          lr  = LinearRegression()
          lr.fit(barX.reshape(-1, 1), [studytime_G123_dict[j][key_i] for j in studytime_list])
...
def plot_bar_Dalc_vs_G(df_maths, df_port, save_path='./plot/bar_Dalc_vs_G.png'):
    ...
    for i in range(len(keys_list)):
        ...
        if 'G3' in key_i:
            lr = LinearRegression()
            lr.fit(barX.reshape(-1, 1), [Dalc_G123_dict[j][key_i] for j in Dalc_list])
            plt.plot(barX + width, lr.coef_ * barX + lr.intercept_, color_list[i])
...
def plot_bar_Walc_vs_G(df_maths, df_port, save_path='./plot/bar_Walc_vs_G.png'):
    ...
    for i in range(len(keys_list)):
        ...
        if 'G3' in key_i:
            lr = LinearRegression()
            lr.fit(barX.reshape(-1, 1), [Walc_G123_dict[j][key_i] for j in Walc_list])
            plt.plot(barX + width, lr.coef_ * barX + lr.intercept_, color_list[i])
...
def plot_bar_Medu_vs_G(df_maths, df_port, save_path='./plot/bar_Medu_vs_G.png'):
    ...
    for i in range(len(keys_list)):
        ...
        if 'G3' in key_i:
            lr = LinearRegression()
            lr.fit(barX.reshape(-1, 1), [Medu_G123_dict[j][key_i] for j in Medu_list])
            plt.plot(barX + width, lr.coef_ * barX + lr.intercept_, color_list[i])
...
def plot_bar_Fedu_vs_G(df_maths, df_port, save_path='./plot/bar_Fedu_vs_G.png'):
    ...
    for i in range(len(keys_list)):
        ...
        if 'G3' in key_i:
            lr = LinearRegression()
            lr.fit(barX.reshape(-1, 1), [Fedu_G123_dict[j][key_i] for j in Fedu_list])
            plt.plot(barX + width, lr.coef_ * barX + lr.intercept_, color_list[i])
